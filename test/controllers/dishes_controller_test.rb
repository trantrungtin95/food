...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { image_url: @dish.image_url, name: @dish.name, price: @dish.price } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { image_url: @dish.image_url, name: @dish.name, price: @dish.price } }
